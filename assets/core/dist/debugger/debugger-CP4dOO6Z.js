...
.btn-dark-primary {
  --bs-btn-color: #fff;
  --bs-btn-bg: #252f3f;
  --bs-btn-border-color: #252f3f;
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: rgb(31.45, 39.95, 53.55);
  --bs-btn-hover-border-color: rgb(29.6, 37.6, 50.4);
  --bs-btn-focus-shadow-rgb: 70, 78, 92;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: rgb(29.6, 37.6, 50.4);
  --bs-btn-active-border-color: rgb(27.75, 35.25, 47.25);
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
  --bs-btn-disabled-bg: #252f3f;
  --bs-btn-disabled-border-color: #252f3f;
}
...
.btn-outline-dark-primary {
  ...
  --bs-btn-focus-shadow-rgb: 37, 47, 63;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #252f3f;
  --bs-btn-active-border-color: #252f3f;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #252f3f;
  --bs-btn-disabled-bg: transparent;
  --bs-btn-disabled-border-color: #252f3f;
  --bs-gradient: none;
}
...
.link-dark-primary:hover, .link-dark-primary:focus {
  color: RGBA(30, 38, 50, var(--bs-link-opacity, 1)) !important;
  text-decoration-color: RGBA(30, 38, 50, var(--bs-link-underline-opacity, 1)) !important;
}
