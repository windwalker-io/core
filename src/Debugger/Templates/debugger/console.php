...
<div id="windwalker-debugger">
	...
	<!-- VERSION -->
	<div class="windwalker-debugger-block">
		<a class="windwalker-debugger-link" href="<?php echo $data->route->encode('system', array('id' => $data->collector['id'])); ?>">
			<div class="windwalker-debugger-block-inner">
	...
	<!-- METHOD -->
	<div class="windwalker-debugger-block">
		<a class="windwalker-debugger-link" href="<?php echo $data->route->encode('request', array('id' => $data->collector['id'])); ?>">
			<div class="windwalker-debugger-block-inner">
				<span class="windwalker-debugger-badge">
	...
	<!-- ROUTING -->
	<div class="windwalker-debugger-block">
		<a class="windwalker-debugger-link" href="<?php echo $data->route->encode('routing', array('id' => $data->collector['id'])); ?>">
			<div class="windwalker-debugger-block-inner">
	...
	<!-- TIME -->
	<div class="windwalker-debugger-block">
		<a class="windwalker-debugger-link" href="<?php echo $data->route->encode('timeline', array('id' => $data->collector['id'])); ?>">
			<div class="windwalker-debugger-block-inner">
	...
	<!-- DATABASE -->
	<div class="windwalker-debugger-block">
		<a class="windwalker-debugger-link" href="<?php echo $data->route->encode('database', array('id' => $data->collector['id'])); ?>">
			<div class="windwalker-debugger-block-inner">
				Queries
				<span class="windwalker-debugger-badge">
